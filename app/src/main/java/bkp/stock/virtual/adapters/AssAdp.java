 ...
 * with image loading
 * */
public class AssAdp extends RecyclerView.Adapter<AssAdp.MyViewHolder> {

    /*
     * list and activity delaration
     * */
    private List<AssignDto> l1;
     ...
     * */
    public AssAdp(Activity activity, List<AssignDto> l1) {
        this.l1 = l1;
        this.activity = activity;
        listner = (ItemClickListner) activity;
    }

    public AssAdp(Activity activity, Fragment fragment, List<AssignDto> l1) {
        this.l1 = l1;
        this.activity = activity;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ass_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        try {
            AssignDto assignDto = l1.get(holder.getAbsoluteAdapterPosition());
            holder.txt1.setText(assignDto.getTitle());
            holder.txt2.setText(assignDto.getLast_date());
            holder.txt3.setText("Subject: "+assignDto.getAss_subject());
                    ...
                    new AlertDialog.Builder(activity)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    myRef.child(assignDto.getAss_id()).removeValue();
            ...
            holder.rl1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(activity.getApplicationContext(), AssignDetail.class);
                    intent.putExtra("uid", assignDto.getAss_id());
