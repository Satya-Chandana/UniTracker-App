 ...
 * with image loading
 * */
public class SudentAdp extends RecyclerView.Adapter<SudentAdp.MyViewHolder> {
...
//            txt1 = view.findViewById(R.id.txt1);
     ...
     * */
    public SudentAdp(Activity activity, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
        listner = (ItemClickListner) activity;
    }

    public SudentAdp(Activity activity, Fragment fragment, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
