...
import bkp.stock.virtual.activities.AddSub;
 ...
 * with image loading
 * */
public class SubAdp extends RecyclerView.Adapter<SubAdp.MyViewHolder> {

    /*
     * list and activity delaration
     * */
    private List<SubDto> l1;
     ...
     * */
    public SubAdp(Activity activity, List<SubDto> l1) {
        this.l1 = l1;
        this.activity = activity;
        listner = (ItemClickListner) activity;
    }

    public SubAdp(Activity activity, Fragment fragment, List<SubDto> l1) {
        this.l1 = l1;
        this.activity = activity;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        try {
            SubDto classDto1 = l1.get(holder.getAdapterPosition());
            holder.txt1.setText(classDto1.getSub_name());

            holder.edit_icon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(activity.getApplicationContext(), AddSub.class);
                    intent.putExtra("uid",classDto1.getSub_id());
                    ...
                    new AlertDialog.Builder(activity)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    myRef.child(classDto1.getSub_id()).removeValue();
