...
public class ClassAc extends AppCompatActivity implements ItemClickListner {

    private RecyclerView rlv1;
    private List<ClassDto1> l1 = new ArrayList<>();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.getValue()!=null && snapshot.hasChildren()){
                    for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                        l1.add(dataSnapshot.getValue(ClassDto1.class));
                    }
                }
                addAdp1();
            }
    ...
    private void addAdp1() {
        ClassAdp catAdp = new ClassAdp(ClassAc.this,l1);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(ClassAc.this, LinearLayoutManager.VERTICAL, false);
